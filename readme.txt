...
Donate link: http://links2tabs.com/
...
The reference bundles are added within `<div id="links2tabs" class="links2tabs"> ... </div>` HTML structure. You can define any styling you like via your theme CSS by either referring to the element `#links2tabs` or class `.links2tabs`.
